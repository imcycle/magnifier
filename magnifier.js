 ...
 *放大镜
 */
//magnifier(父集盒子,主图宽,主图高,图片路径,图片遮罩层宽,遮罩层高,放大盒子宽);
...
function magnifier(fatherName,MainWidth,MainHeight,img_src,SelectWidth,SelectHeight,BigBoxWidth){
    ...
    $(".magnifierMainBox").mouseenter(function(){
        ...
        _left<0?_left=0:"";
        _left>MainWidth-SelectWidth?_left=MainWidth-SelectWidth:"";
        _top<0?_top=0:"";
        _top>MainHeight-SelectHeight?_top=MainHeight-SelectHeight:"";
        $(".magnifierSelect").css({
            "left":_left + "px",
            "top":_top + "px"
        })
